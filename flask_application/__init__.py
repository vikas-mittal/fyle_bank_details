...
from flask_application.rest import api
...
db = SQLAlchemy(app)
appdbsessionmaker = sessionmaker(bind=db.engine)
...
#to add functionalities used for the dashboard
# from flask_application.public.controllers import DataNormalization
# DataNormalization.register(app)
